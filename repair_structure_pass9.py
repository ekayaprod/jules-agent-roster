...
_schizophrenic_bullet_patterns = [re.compile(r'^.*?' + bullet + r'.*$\n?', flags=re.MULTILINE) for bullet in _schizophrenic_bullets]
...
def process_file(filepath):
    ...
    for pattern in _schizophrenic_bullet_patterns:
