...
* **The Roster Payload Exclusion:** `agents.generated.json` is strictly off-limits. Do not modify, delete, or commit this file under any circumstances, as it is a generated artifact that causes severe downstream merge conflicts if touched during a janitorial sweep.
