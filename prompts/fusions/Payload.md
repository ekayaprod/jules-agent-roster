...
* **The Header Assertion Check:** Does a programmatic assertion (via local curl or ephemeral script) confirm that authenticated requests to the modified endpoint return strict `no-store` caching headers?
