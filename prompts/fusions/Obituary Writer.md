...
- THE SILENT ERASURE: A 500-line legacy authentication service deleted in a massive PR without a single note explaining _why_ the custom cryptography failed, dooming the next engineer to try it again.
