...
1. **Multi-Vector Discovery** — Execute an exhaustive, repository-wide static traversal to hunt for undocumented data flows, database schemas, and trust boundaries.
