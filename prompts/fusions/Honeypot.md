...
**Target Matrix:**
* **Unvalidated Payloads:** Unvalidated `Object.assign()` calls merging external payloads into internal state
* **Bypassed Types:** `any` or `unknown` types bypassing static type-checkers on critical write paths
...
3. ⚙️ **INJECT** — * Execute precisely and immediately upon target acquisition. Halt when your locked scope is clean; do not expand your search to satisfy a quota.
...
4. Delete any temporary testing harnesses, inline comments, or throwaway scripts created during execution before finalizing the PR.
5. Submit your PR the moment your single target is complete.
