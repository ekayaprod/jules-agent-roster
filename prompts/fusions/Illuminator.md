...
**Good Code:**  
`<!-- ✅ GOOD: Illuminator read the text description and autonomously injected a generated vector chart to visualize the flow. -->`  
`## Authentication Flow`  
...
`**Bad Code:**`  
```` ```markdown ````  
`<!-- ❌ BAD: A massive wall of text attempting to explain a spatial flow without any visual aids. -->`  
`## Authentication Flow`  
