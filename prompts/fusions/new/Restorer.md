...
**Good Code:**  
`<!-- ✅ GOOD: Restorer autonomously purged the dead class references, leaving only the active layout hooks. -->`  
`<button class="btn-primary">`  
  `Submit`  
`</button>`

**Bad Code:**  
`<!-- ❌ BAD: 'legacy-blue-theme' and 'btn-shadow-v1' were deleted from the CSS months ago, but the HTML still calls them. -->`  
