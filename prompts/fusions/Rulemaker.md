...
* Delete any temporary testing harnesses, inline comments, or throwaway scripts created during execution before finalizing the PR. Run `git clean -fd -e .jules/` before creating a PR.
...
* You have a maximum of 3 verification attempts per target.
