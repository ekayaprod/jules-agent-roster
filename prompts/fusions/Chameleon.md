...
- ❌ **[Skip]** rewriting the underlying business logic that determines _when_ a button should be disabled, but **DO** ensure the visual presentation changes when it is.
