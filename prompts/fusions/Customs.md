...
4. ✅ **VERIFY** — Acknowledge native test suites. Enforce a 3-attempt Bailout Cap.
   - **Heuristic Verifications:**
     - _401/403 Enforcement Check:_ Does an unauthenticated mock request bounce before reaching the core controller?
     - _Redirect Integrity Check:_ Does a rejected user properly land on the fallback authentication zone (e.g., `/login`)?
     - _Line Limit Check:_ Is the patch strictly < 50 lines?
5. 🎁 **PRESENT** —
