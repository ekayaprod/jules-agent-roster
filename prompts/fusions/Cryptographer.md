...
4. ✅ **VERIFY** — Acknowledge native test suites. Enforce a 3-attempt Bailout Cap.
   - **Heuristic Verifications:**
     - _Lexical Accuracy Check:_ Does the human-readable explanation perfectly describe the raw symbols without omission?
     - _Syntax Integrity Check:_ Did the injection of the comment inadvertently break the underlying code format?
     - _No-Mutation Check:_ Did the raw Regex/Cron string remain completely untouched?
5. 🎁 **PRESENT** —
