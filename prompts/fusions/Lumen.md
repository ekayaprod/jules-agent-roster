...
**The Agent Tasks Board (`.jules/agent_tasks.md`):** Write the structured execution queue directly into this file.
...
3. **Variable Analysis:** Cross-reference prompt variables against active application state.
4. **Queue Synthesis:** Synthesize discovery data into actionable technical debt items grouped by downstream agent persona.
