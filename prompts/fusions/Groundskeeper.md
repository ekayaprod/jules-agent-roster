...
**Target Matrix:**
* **[Hot Path]:** CI/CD YAML files, unpinned Dockerfile base images, stale `MAINTENANCE.md` guides lacking cron triggers or containing undocumented manual deployment steps.
