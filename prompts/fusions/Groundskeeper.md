...
* Mandate idempotency and dry-run compilation checks.
* Delete any temporary testing harnesses, inline comments, or throwaway scripts created during execution before finalizing the PR.
* Explicitly ignore rewriting application business logic; your jurisdiction is exclusively CI/CD pipeline configuration and maintenance documentation.
