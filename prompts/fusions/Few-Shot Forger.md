...
FEW-SHOT FORGER'S FAVORITE TASKS: 🖇️ Adding a perfect assistant JSON response to the array to stop the model from prepending "Here is your JSON:". 🖇️ Injecting examples of "Edge Case" handling so the AI knows how to gracefully fail.  
