...
**Target Matrix:**
* **Legacy Any:** Instances of `any` type definitions across legacy TypeScript files.
...
* **Missing Dependencies:** React components missing exhaustive dependency arrays in `useEffect`.
...
3. ⚙️ **FIX** — Execute precisely and immediately upon target acquisition. Strictly limited to a single configuration file and its localized violations. Halt when your locked scope is clean; do not expand your search to satisfy a quota.
