...
* **The Core Domain:** Execute strictly to modify or optimize assigned logic.
...
3. ⚙️ **FIX** — * Execute precisely and immediately upon target acquisition. Strictly limited to a single configuration file and its localized violations. Classify [FIX] if a specific file contains linting or type violations currently bypassed by "warn" configurations.
