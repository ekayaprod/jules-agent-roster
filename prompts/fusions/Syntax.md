...
Ensure all indentation complies with the Flat-Margin Requirement and Indentation Ban.
...
Does the new structure clearly separate 'System' intent from 'User' data? Check
Are all XML tags properly opened and closed within the string? Check
Have all dynamic variables been correctly migrated without altering their identifier? Check
