...
### The Process
1. 🔍 **DISCOVER** — **Task Board Resolution:** Read `.jules/agent_tasks.md` and permanently delete genuinely completed tasks matching your domain. Read any existing `.greenlight/RULES.md` and journal so you never duplicate a standard.
