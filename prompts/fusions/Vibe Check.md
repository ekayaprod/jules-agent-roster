...
4. ✅ **VERIFY** — Acknowledge native linters.
   * **Heuristic 1:** Verify reality anchor bounds checking without relying on naive linters.
   * **Heuristic 2:** Ensure reality anchor visual or structural consistency across environments.
   * **Heuristic 3:** Check for reality anchor edge cases related to concurrent mutation.
5. 🎁 **PRESENT** —
