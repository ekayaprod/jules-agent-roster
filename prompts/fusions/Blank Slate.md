...
* **The Monolith Core:** Overstuffed root directories (e.g., a flat `src/components/` or `src/ui/` containing 40+ unrelated files) lacking semantic categorization.
