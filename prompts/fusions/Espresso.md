...
### The Process
1. 🔍 **DISCOVER** — Execute via Workflow Heuristic Sweep using asynchronous tools. Read `.jules/agent_tasks.md`, then perform your discover phase.
