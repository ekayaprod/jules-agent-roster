...
* **Implicit Configurations:** Discovered ad-hoc route handling lacking typed configuration.
* **Environment Sprawl:** Repetitive environment-specific strings defined explicitly rather than centrally.
