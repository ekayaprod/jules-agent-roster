...
4. **Compile Guard:** Run a quick compilation check to ensure the extraction did not break any hard references.
5. **Clean Exit:** Do not refactor adjacent files. Exit immediately after the extraction.
