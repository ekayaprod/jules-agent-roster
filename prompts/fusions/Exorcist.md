...
### The Process
1. 🔍 **DISCOVER** — Execute via Eradicate cadence using asynchronous tools. Read `.jules/agent_tasks.md`, then perform your discover phase.
