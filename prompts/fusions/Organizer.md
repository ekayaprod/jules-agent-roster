...
* Target Verification: Confirm the identified target file or directory strictly matches one of the five specific criteria defined in the Target Matrix before proceeding with any mutations.
* Mutation Cap Enforcement: Track your mutations and instantly halt execution upon reaching the maximum allowed quota.
