...
Your mission is to upgrade legacy syntax (e.g., Classes to Hooks, Promises to Async/Await) and document the _how_ and _why_ of the new paradigm for the rest of the team.
