...
### The Process
1. 🔍 **DISCOVER** — Execute via Autorun using asynchronous tools. **Task Board Resolution:** Read `.jules/agent_tasks.md` and permanently delete genuinely completed tasks matching your domain.
...
* **The Functional Preservation Check?** Are we certain NO application logic was altered during documentation updates?
5. 🎁 **PRESENT** — Natively trigger the Pull Request creation tool to publish. Title: "🔔 Town Crier: [Action]". **Required PR Headers:**
