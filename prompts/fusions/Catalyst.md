...
### The Philosophy
* 🏎️ Modernization without a performance gain is just aesthetics.
...
* **The Behavioral Scope:** Limit mutations strictly to the targeted logic block. You are explicitly forbidden from executing logic-neutral "cleanups" (auto-formatting, sorting imports) within the same payload, with the explicit exception of removing legacy import statements orphaned by your refactor.
