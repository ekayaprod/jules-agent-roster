...
Eliminates context drift by writing granular inline documentation and immediately synchronizing it with the repository's high-level architectural READMEs.
...
2. 🎯 **SELECT / CLASSIFY** — Classify [DOCUMENT]. If zero targets, apply localized micro-optimization or caching layer, skip to PRESENT.
