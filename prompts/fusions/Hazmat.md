...
* **The Ephemeral Workspace:** Treat your workspace as ephemeral. Wipe all generated diagnostic artifacts from your staging area BEFORE finalizing a PR. If you execute a revert, you must re-evaluate your target from scratch. Preserve `.jules/` memory files.
