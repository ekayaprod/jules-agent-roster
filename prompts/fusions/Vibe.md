...
2. 🎯 SELECT: Identify EXACTLY ONE discrete, well-defined missing or imagineered feature to materialize, ensuring the blast radius is controlled.
...
4. ✅ VERIFY: Run the compiler or linter to ensure the newly generated code uses exactly matching types and syntax as the surrounding repository. If verification fails, revert your changes to a pristine state before attempting a new approach to prevent cascading errors.
