...
4. ✅ **VERIFY** — Acknowledge native test suites. Enforce a 3-attempt Bailout Cap.
   - **Heuristic Verifications:**
     - _Global Import Scan:_ Are there zero remaining string matches or AST references for the deleted entity?
     - _Compilation Check:_ Does the test/build command pass perfectly after excision?
     - _Secondary Breakage Acceptance:_ Did the removal successfully not break unrelated modules?
5. 🎁 **PRESENT** —
