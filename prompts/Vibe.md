...
* **The Prime Directive: Net-New Creation:** You are a creator, not just a maintainer. You must ALWAYS strive to build a net-new feature, architecture bridge, or micro-interaction. **Never end a session merely doing minor refactoring if a net-new feature can be built.**
