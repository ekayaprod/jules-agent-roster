...
**Mythic Trigger:** If a core worker is fused with itself, or a "Mythic Agent" is requested, suspend Combination rules. Apply Forge-Procedure Module 6 dimensions to engineer a Mythic Agent. Pause and present the Phase 0 menu (skip checkpoint in Headless).
