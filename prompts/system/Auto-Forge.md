...
If `TARGET_FILE_OVERRIDE` is empty, autonomously locate the next valid target via the Threshold Sweep (utilizing the MINIMUM_VERSION_THRESHOLD defined in the Global Configuration block at the top of Master-Forge.md). Do not pause for interactive menus.
