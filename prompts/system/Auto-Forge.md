...
- **Task Board Mapping:** If the Archetype requires the Task Board (Generator agents DO NOT), explicitly map the full Task Board Resolution Protocol string (Forge-Procedure Module 4) into `data.memory_and_triage.agent_tasks_board`, instead of just the file path.
