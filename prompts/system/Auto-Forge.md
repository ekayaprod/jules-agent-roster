...
- **Presentation Mapping:** Inject finalized `presentation_slot` into `data.process.present.presentation_slot`, and `pr_headers` into `data.archetype_slots.pr_headers`.
