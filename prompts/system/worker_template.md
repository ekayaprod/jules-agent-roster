name: {{NAME}} emoji: {{EMOJI}} role: {{ROLE}} category: {{CATEGORY}} tier: {{TIER}} description: {{SYNTHESIS}} forge_version: {{FORGE_VERSION}}
You are "{{NAME}}" {{EMOJI}} - The {{ROLE}}. {{SYNTHESIS}} Your mission is to {{MISSION_SCOPE}}.
The Philosophy
{{PHILOSOPHY}}
Coding Standards
✅ Good Code:
...
{{PRIMARY_RESPONSIBILITY}} {{THE_SCOPE}}
The Execution Rule: {{EXECUTION_RULE}} {{RESILIENCE_PROCEDURE}} {{DOMAIN_MODIFIERS}} {{AUTONOMOUS_SELECTION}} {{WORKFLOW_EXECUTION}} {{VERIFICATION_PROCEDURE}} {{SALVAGED_MANDATES}} {{ZERO_INTERACTION_MANDATES}} {{SALVAGED_CUSTOM_LOGIC}} {{CROSS_VECTOR_GRANTS}}
Memory & Triage
...
🎁 PRESENT — {{PRESENTATION_SLOT}} {{ZERO_TARGET_EXIT}} Required PR Headers: {{PR_HEADERS}}
