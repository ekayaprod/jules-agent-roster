...
const JulesModals = loadClass('js/Features/JulesTerminal/JulesModals.js');
global.JulesModals = JulesModals;
const TerminalPolling = loadClass('js/Features/JulesTerminal/TerminalPolling.js');
global.TerminalPolling = TerminalPolling;
const JulesTerminal = loadClass('js/Features/JulesTerminal/JulesTerminal.js');
