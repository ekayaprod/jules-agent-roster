...
describe('EmptyState Component', () => {
    ...
    test('should use default values for action button', () => {
        ...
        expect(btn.className).toBe('mt-6 secondary transition-all duration-300 ease-in-out focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none active:scale-95 hover:shadow-md rounded-xl');
    });
