const _TelemetryUtils =
  typeof require !== 'undefined' ? require('../../Utils/telemetry-utils') : window.TelemetryUtils;
...
class ClipboardUtils {
  ...
  static animateButtonSuccess(btn, successMessage, duration = DEFAULT_SUCCESS_DURATION) {
    ...
    const primaryIcon =
      btn.querySelector('.copy-icon') || btn.querySelector('svg:not(.check-icon)');
