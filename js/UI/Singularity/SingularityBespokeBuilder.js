class SingularityBespokeBuilder {
  ...
  render() {
    this.container.innerHTML = `
      <div class="singularity-builder card p-6" style="border: 2px solid var(--success); background: var(--card-bg); box-shadow: 0 0 0.9375rem rgba(16, 185, 129, 0.2);">
        <h3 style="color: var(--success); display: flex; align-items: center; gap: 0.5rem; margin-top: 0;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem;">
          <div style="display: flex; gap: 1rem;">
            <div style="flex: 1;">
              <label for="singularityAgentName" style="display: block; font-size: var(--text-sm); font-weight: 600; margin-bottom: 0.25rem;">Agent Name</label>
              <input type="text" id="singularityAgentName" placeholder="e.g., Code Sweeper" class="modal-input" style="width: 100%;" />
            </div>
            <div style="width: 4rem;">
              <label for="singularityAgentEmoji" style="display: block; font-size: var(--text-sm); font-weight: 600; margin-bottom: 0.25rem;">Emoji</label>
          ...
          <div>
            <div style="display: flex; gap: 0.5rem; margin-bottom: 0.5rem;">
              <button class="quick-fill-pill" data-mission="Refactor legacy code to modern standards." data-constraints="Match Existing Styling, Do not modify tests" style="font-size: var(--text-xs); padding: 0.25rem 0.5rem; border-radius: 1rem; border: 1px solid var(--success); background: transparent; color: var(--success); cursor: pointer;">✨ Refactor Legacy</button>
              <button class="quick-fill-pill" data-mission="Enforce strict typing and add validation guards." data-constraints="No UI Mutations, Match Existing Styling" style="font-size: var(--text-xs); padding: 0.25rem 0.5rem; border-radius: 1rem; border: 1px solid var(--success); background: transparent; color: var(--success); cursor: pointer;">🛡️ Enforce Types</button>
              <button class="quick-fill-pill" data-mission="Prune dead code and remove unused files." data-constraints="No UI Mutations" style="font-size: var(--text-xs); padding: 0.25rem 0.5rem; border-radius: 1rem; border: 1px solid var(--success); background: transparent; color: var(--success); cursor: pointer;">🧹 Prune Dead Code</button>
            </div>
            <label for="singularityMission" style="display: flex; align-items: center; justify-content: space-between; font-size: var(--text-sm); font-weight: 600; margin-bottom: 0.25rem;">
              Core Mission
              <span id="singularityArchetypeBadge" style="font-size: var(--text-xs); padding: 0.15rem 0.4rem; border-radius: 0.25rem; background: var(--details-bg); border: 1px solid var(--border);">🛠️ Maker</span>
            </label>
          ...
          <div>
            <label style="display: block; font-size: var(--text-sm); font-weight: 600; margin-bottom: 0.5rem;">Safety Constraints</label>
          ...
          <div>
            <button id="singularityAdvancedToggle" style="font-size: var(--text-sm); font-weight: 600; background: transparent; border: none; color: var(--success); cursor: pointer; padding: 0; text-decoration: underline;">
            ...
            <div id="singularityAdvancedOptions" class="advanced-options" style="display: none; flex-direction: column; gap: 1rem; margin-top: 1rem;">
              <div>
                <label for="singularityTechStack" style="display: block; font-size: var(--text-sm); font-weight: 600; margin-bottom: 0.25rem;">Primary Tech Stack (Optional)</label>
                <input type="text" id="singularityTechStack" placeholder="e.g., React, Node.js, Python" class="modal-input" style="width: 100%;" />
              </div>
              <div>
                <label for="singularityTargets" style="display: block; font-size: var(--text-sm); font-weight: 600; margin-bottom: 0.25rem;">Target Directories (Optional)</label>
          ...
          <div style="margin-top: 1rem;">
            <button id="singularitySubmitBtn" style="width: 100%; background: var(--success); color: var(--bg-color); font-weight: bold; border: none; padding: 0.75rem; border-radius: 0.25rem; cursor: pointer;">
              Forge Bespoke Agent
            </button>
          </div>
        </div>
