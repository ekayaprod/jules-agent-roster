...
describe('PinnedManager', () => {
    ...
    describe('Initialization', () => {
        it('should initialize with an empty set if localStorage returns null', () => {
            ...
            expect(global.StorageUtils.getJsonArrayItem).toHaveBeenCalledWith("jules_pinned_agents", "PINNED_LOAD_FAILED");
        });
    ...
    describe('State Mutations (togglePin)', () => {
        ...
        it('should add a key if it does not exist and call save()', () => {
            ...
            expect(global.StorageUtils.setJsonItem).toHaveBeenCalledWith("jules_pinned_agents", ['agent_1'], "PinnedManager");
        });
        ...
        it('should remove a key if it already exists and call save()', () => {
            ...
            expect(manager.getPinned()).toEqual([]);
            expect(global.StorageUtils.setJsonItem).toHaveBeenCalledWith("jules_pinned_agents", [], "PinnedManager");
        });
        ...
        it('should survive heavy concurrency stress mutations without race condition drops', async () => {
            ...
            const additions = ['a1', 'a2', 'a3', 'a4', 'a5'].map(key => async () => manager.togglePin(key));
