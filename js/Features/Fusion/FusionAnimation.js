...
const FusionAnimation = function () {
  ...
  const injectParticles = (particlesContainer, tier) => {
  ...
  const updateResultUI = (iconLeft, iconRight, animResult, iconResult, agentA, agentB, result) => {
  ...
  const executeAnimation = async (overlay, fuseBtn, controls, showResultCallback) => {
  ...
  const runAnimation = async (agentA, agentB, result, showResultCallback) => {
    ...
    injectParticles(particlesContainer, tier);

    updateResultUI(iconLeft, iconRight, animResult, iconResult, agentA, agentB, result);

    await executeAnimation(overlay, fuseBtn, controls, showResultCallback);
  };
