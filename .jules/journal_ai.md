...
**Hallucination Risk:** Unguarded Session Creation API Call | **Constraint:** Injected performance.now() and native TelemetryUtils dispatch around this._fetch() boundary
